...
describe 'navigate' do
  ...
  describe 'index' do
    ...
    it 'has a scope so that only post creators can see their posts' do
      ...
      other_user = User.create(first_name: "Non", last_name: "Authorized", email: "non@test.com", password: "123456", password_confirmation: "123456")
  ...
  describe 'edit' do
    ...
    before do
      @edit_user = User.create(first_name: "asdf", last_name: "asdf", email: "asdf.sadf@asdf.com", password: "sadasdf", password_confirmation: "sadasdf" )
